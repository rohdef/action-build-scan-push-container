(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', '@docker/actions-toolkit/lib/github', '@docker/actions-toolkit/lib/docker/docker', '@docker/actions-toolkit/lib/toolkit', '@docker/actions-toolkit', '@actions/core', './kotlin-kotlin-stdlib.js', './kotlinx-coroutines-core.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('@docker/actions-toolkit/lib/github'), require('@docker/actions-toolkit/lib/docker/docker'), require('@docker/actions-toolkit/lib/toolkit'), require('@docker/actions-toolkit'), require('@actions/core'), require('./kotlin-kotlin-stdlib.js'), require('./kotlinx-coroutines-core.js'));
  else {
  ...
  function main($completion) {
    var tmp = new Core_0();
    return tmp.sh(main$slambda_0(null), VOID, $completion);
  }
  ...
  protoOf(actionInfo$slambda_3).ci = function ($this$group, $completion) {
    var tmp = this.di($this$group, $completion);
    tmp.a4_1 = Unit_instance;
    tmp.b4_1 = null;
    return tmp.g4();
  };
  protoOf(actionInfo$slambda_3).q4 = function (p1, $completion) {
    return this.ci(p1 instanceof Core_0 ? p1 : THROW_CCE(), $completion);
  };
  protoOf(actionInfo$slambda_3).g4 = function () {
    var suspendResult = this.a4_1;
    $sm: do
      try {
        var tmp = this.y3_1;
  ...
  protoOf(actionInfo$slambda_3).di = function ($this$group, completion) {
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.y3_1 = 2;
            suspendResult = actionInfo(this.gj_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            ...
            continue $sm;
          case 2:
            this.gj_1.jj('We just fail right now');
            return Unit_instance;
          case 3:
            throw this.b4_1;
        }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.z3_1 = 4;
            this.y3_1 = 1;
            suspendResult = this.rh_1.kj('GitHub Actions runtime token ACs', actionInfo$slambda_0(null), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            this.y3_1 = 2;
            suspendResult = this.rh_1.kj('Docker info', actionInfo$slambda_2(null), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            this.y3_1 = 3;
            suspendResult = this.rh_1.kj('Buildx version', actionInfo$slambda_4(null), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(Core$run$lambda$slambda).wj = function ($this$promise, $completion) {
    var tmp = this.xj($this$promise, $completion);
    tmp.a4_1 = Unit_instance;
    tmp.b4_1 = null;
    return tmp.g4();
  };
  protoOf(Core$run$lambda$slambda).q4 = function (p1, $completion) {
    return this.wj((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  };
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.z3_1 = 2;
            this.y3_1 = 1;
            suspendResult = this.tj_1(this.uj_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(Core$run$lambda$slambda).xj = function ($this$promise, completion) {
    var i = new Core$run$lambda$slambda(this.tj_1, this.uj_1, completion);
    i.vj_1 = $this$promise;
    return i;
  };
  function Core$run$lambda$slambda_0($main, this$0, resultContinuation) {
    ...
    var l = function ($this$promise, $completion) {
      return i.wj($this$promise, $completion);
    };
    l.$arity = 1;
    return l;
  }
  ...
  protoOf(Core$run$slambda).wj = function ($this$promise, $completion) {
    var tmp = this.xj($this$promise, $completion);
    tmp.a4_1 = Unit_instance;
    tmp.b4_1 = null;
    return tmp.g4();
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.z3_1 = 2;
            this.y3_1 = 1;
            suspendResult = this.gk_1(this.hk_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(Core$run$slambda).xj = function ($this$promise, completion) {
    var i = new Core$run$slambda(this.gk_1, this.hk_1, completion);
    i.ik_1 = $this$promise;
    return i;
  };
  ...
  protoOf(Core$group$lambda$slambda).wj = function ($this$promise, $completion) {
    var tmp = this.xj($this$promise, $completion);
    tmp.a4_1 = Unit_instance;
    tmp.b4_1 = null;
    return tmp.g4();
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.z3_1 = 2;
            this.y3_1 = 1;
            suspendResult = this.rk_1(this.sk_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(Core$group$lambda$slambda).xj = function ($this$promise, completion) {
    var i = new Core$group$lambda$slambda(this.rk_1, this.sk_1, completion);
    i.tk_1 = $this$promise;
    return i;
  };
  ...
  protoOf(Core_0).uk = function (main, post, $completion) {
  ...
  protoOf(Core_0).sh = function (main, post, $completion, $super) {
    ...
    return $super === VOID ? this.uk(main, post, $completion) : $super.uk.call(this, main, post, $completion);
  };
  protoOf(Core_0).kj = function (name, contents, $completion) {
    var tmp = Core;
    return await_0(tmp.group(name, Core$group$lambda(contents, this)), $completion);
  };
  protoOf(Core_0).jj = function (message) {
